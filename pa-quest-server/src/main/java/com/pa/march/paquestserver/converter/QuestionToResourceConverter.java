...
@Component
@Slf4j
public class QuestionToResourceConverter extends ConversionServiceAwareConverter<Question, QuestionResource> {

    @Override
    public QuestionResource convert(Question question) {
