...
public class AnswerSpecification implements Specification<Answer> {
    ...
    public AnswerSpecification(final SearchCriteria criteria) {
        super();
    ...
    @Override
    public Predicate toPredicate(Root<Answer> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
        ...
        query.orderBy(builder.asc(root.get(Answer.FIELD_TEXT)));
        return predicate;
